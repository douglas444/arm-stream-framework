...
public class Model {
    ...
    private Model(final List<PseudoPoint> pseudoPoints,
                  final double accuracyAssociationCorrelation,
                  final double accuracyPurityCorrelation,
                  final HashSet<Integer> knownLabels) {
    ...
    public List<Sample> getPseudoPointsCentroid() {
        return this.pseudoPoints.stream()
